...
# kernel_size 只对第二个卷积有效
# stage 和 block 用于命名
def idendity_block(input_tensor, kernel_size, filters, stage, block):
    filters1, filters2, filters3 = filters
    conv_name_base = 'res' + str(stage) + block + '_branch'
    bn_name_base = 'bn' + str(stage) + block + '_branch'

    x = Conv2D(filters1, (1,1), name = conv_name_base + '2a')(input_tensor) # (1,1)降维
    ...
    x = Conv2D(filters3, (1,1), name = conv_name_base + '2c')(x) # (1,1) 升维
