...
def test() :
    ...
    debug = False
    model = LinearLeastSquareModel(input_columns,output_columns,debug=debug) # 累的实例化：用最小二乘法
    ...
    if 1:
        ...
        sord_idxs = np.argsort(A_exact[:,0])
        A_col0_sorted = A_exact[sord_idxs] # 秩为2的数组
