...
from homework_w14_yolo_model import Yolo
...
class YoloPredictor:
    ...
    def predict(self, inputs, image_shape):
        ...
        -------
            ...
            classes: 物体类别
        """
        model = Yolo(homework_w14_yolo_config.norm_epsilon, homework_w14_yolo_config.norm_decay, self.anchors_path,
                     self.classes_path, pre_train=False)
        # yolo_inference用于获得网络的预测结果
        output = model.yolo_inference(inputs, homework_w14_yolo_config.num_anchors // 3,
                                      homework_w14_yolo_config.num_classes, training=False)
