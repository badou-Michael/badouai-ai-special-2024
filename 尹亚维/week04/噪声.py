...
img2 = util.random_noise(img, mode='localvar')
cv2.imshow('localvar', img2)
img3 = util.random_noise(img, mode='poisson')
cv2.imshow('poisson', img3)
img4 = util.random_noise(img, mode='salt')
cv2.imshow('salt', img4)
img5 = util.random_noise(img, mode='pepper')
cv2.imshow('pepper', img5)
img6 = util.random_noise(img, mode='s&p')
cv2.imshow('s&p', img6)
img7 = util.random_noise(img, mode='speckle')
cv2.imshow('speckle', img7)
cv2.waitKey(0)
