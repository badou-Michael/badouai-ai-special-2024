...
import time
import math
from my_cifar.cifar10_data import inputs
...
images_train,  labels_train = inputs(data_dir=data_dir,  batch_size=batch_size,  apply_augmentation=True)
images_test,  labels_test = inputs(data_dir=data_dir,  batch_size=batch_size,  apply_augmentation=None)
