...
#具体说明见官方文档：https://scikit-image.org/docs/stable/api/skimage.util.html#skimage.util.random_noise
'''
...
noise_gauss_img=util.random_noise(img,mode='gaussian',mean=0,var=0.01)
# 这里是方差

cv.imshow("source", img)
cv.imshow("lenna_poisson",noise_poisson_img)
cv.imshow("lenna_gauss",noise_gauss_img)
