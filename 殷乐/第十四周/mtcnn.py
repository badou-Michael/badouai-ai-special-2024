...
class mtcnn():
    def __init__(self):
        # 创建模型结构
        self.Pnet = create_Pnet('model_data/mtcnn/pnet.h5')
        self.Rnet = create_Rnet('model_data/mtcnn/rnet.h5')
        self.Onet = create_Onet('model_data/mtcnn/onet.h5')
