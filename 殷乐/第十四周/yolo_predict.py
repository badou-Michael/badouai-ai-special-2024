...
class yolo_predictor:
    ...
    def predict(self, inputs, image_shape):
        ...
        -------
            ...
            classes: 物体类别
        """
        model = yolo(yolo_config.norm_epsilon, yolo_config.norm_decay, self.anchors_path, self.classes_path,
                     pre_train=False)
        # yolo_inference用于获得网络的预测结果
        output = model.yolo_inference(inputs, yolo_config.num_anchors // 3, yolo_config.num_classes, training=False)
