...
noise_gs_img = util.random_noise(img, mode='gaussian', mean=2, var=4)

noise_sUp_img = util.random_noise(img, mode='s&p', amount=0.8)

combined_img = np.hstack([img/255, noise_gs_img,noise_sUp_img])
