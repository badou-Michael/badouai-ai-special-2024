#本文件的是cifar10第二部分：构造神经网络的整体结构，并进行训练和推理
import tensorflow as tf
import numpy as np
import time
import math
import week11_cifar10_data

max_steps=4000
batch_size=100
num_examples_for_eval=10000
data_dir="week11_cifar_data/cifar-10-batches-bin"
...
images_train,labels_train=week11_cifar10_data.inputs(data_dir=data_dir,batch_size=batch_size,distorted=True)
images_test,labels_test=week11_cifar10_data.inputs(data_dir=data_dir,batch_size=batch_size,distorted=None)
