...
def InceptionV3_self(input_shape=[299, 299, 3],
                classes=1000):
    ...
    # conv
    x = conv2d_bn(x, 192, 3, 3,strides = (2,2), padding='valid')
    x = conv2d_bn(x, 288, 3, 3, padding='valid')
