...
from yolov3_self import yolov3_self


class yolov3_predictor_self:
    ...
    def predict(self, inputs, image_shape):
        # 建立yolo对象
        model = yolov3_self(config.norm_epsilon, config.norm_decay, self.anchors_path, self.classes_path, pre_train=False)
        # 获得预测结果
