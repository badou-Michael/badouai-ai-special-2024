...
#椒盐噪声
img = cv2.imread("lenna.png")
noise_sandp_img = util.random_noise(img,'s&p')
#泊松噪声
img = cv2.imread("lenna.png")
noise_poisson_img = util.random_noise(img,'poisson')

#噪声图与原图对比
cv2.imshow("Source Image", img)
cv2.imshow("lenna gaussian noise",noise_gs_img)
cv2.imshow("lenna pepper&salt noise",noise_sandp_img)
cv2.imshow("lenna poisson noise",noise_poisson_img)
cv2.waitKey(0)
