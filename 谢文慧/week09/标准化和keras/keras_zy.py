...
# 训练集train_images是一个含有60000个元素的数组，每个元素是一个28*28的二位数组
print('train_images.shape = ',train_images.shape)
# 训练集标签，0-9
print('tran_labels = ', train_labels)
# 测试集和训练集的图片大小一致，但是总共是10000张图片
...
# p = cv2.imread(picture)
cv2.imshow('ping',picture)
cv2.waitKey(0)
...
#to_categorical 将数字转换为 one_hot向量
...
(t_imgs,t_label),(test_imgs,test_labels) = mnist.load_data()
