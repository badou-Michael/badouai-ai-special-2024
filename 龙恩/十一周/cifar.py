...
images_train,labels_train=cifar_data.inputs(data_dir=data_dir,batch_size=batch_size,distorted=True)
images_test,labels_test=cifar_data.inputs(data_dir=data_dir,batch_size=batch_size,distorted=None)
