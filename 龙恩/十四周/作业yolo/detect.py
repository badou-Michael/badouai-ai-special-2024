...
def detect(image_path, model_path, yolo_weights = None):
    ...
    with tf.Session() as sess:
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            label_width = label_bbox[2] - label_bbox[0]  # 计算文本的宽度
            label_height = label_bbox[3] - label_bbox[1]  # 计算文本的高度
            ...
            draw.rectangle(
                [tuple(text_origin), (text_origin[0] + label_width, text_origin[1] + label_height)],
